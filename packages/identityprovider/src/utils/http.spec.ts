...
import { _defaultHttpRequestFunctionFactory, IdentityproviderError } from "./http";
...
describe("defaultHttpRequestFunctionFactory", () => {
  ...
  describe("error-handling", () => {
    ...
    describe("on statusCode 400", () => {
      ...
      it("should throw BadInputError on IdentityproviderErrorDto", async () => {
      ...
      it("should throw generic BadInputError on missing IdentityproviderErrorDto", async () => {
        ...
        expect(expectedError instanceof BadInputError).toBeTruthy();
        expect(expectedError.message).toEqual("Identityprovider-App responded with Status 400 indicating bad Request-Parameters. See 'originalError'-property for details.");
        expect(expectedError.originalError).toBe(error);
      });
    });
    ...
    describe("on statusCode 401", () => {
      ...
      it("should throw Unauthorized on IdentityproviderErrorDto", async () => {
      ...
      it("should throw generic IdentityproviderError on missing Body", async () => {
        ...
        expect(expectedError instanceof UnauthorizedError).toBeTruthy();
        expect(expectedError.message).toEqual("Identityprovider-App responded with Status 401 indicating bad authSessionId.");
        expect(expectedError.originalError).toBe(error);
      });
    });
    ...
    describe("on statusCode 403", () => {
      ...
      it("should throw ForbiddenError on IdentityproviderErrorDto", async () => {
      ...
      it("should throw generic ForbiddenError on missing IdentityproviderErrorDto", async () => {
        ...
        expect(expectedError instanceof ForbiddenError).toBeTruthy();
        expect(expectedError.message).toEqual("Identityprovider-App responded with Status 403 indicating a forbidden action. See 'originalError'-property for details.");
        expect(expectedError.originalError).toBe(error);
      });
    });
    ...
    describe("on statusCode 404", () => {
      ...
      it("should throw NotFoundError on IdentityproviderErrorDto", async () => {
      ...
      it("should throw generic BadInputError on missing IdentityproviderErrorDto", async () => {
        ...
        expect(expectedError instanceof NotFoundError).toBeTruthy();
        expect(expectedError.message).toEqual("Identityprovider-App responded with Status 404 indicating a requested resource does not exist. See 'originalError'-property for details.");
        expect(expectedError.originalError).toBe(error);
      });
    });
    ...
    describe("on unknown statusCode", () => {
      ...
      it("should throw IdentityproviderError on IdentityproviderErrorDto", async () => {
        ...
        expect(expectedError instanceof IdentityproviderError).toBeTruthy();
        expect(expectedError.message).toEqual((error.response.data as any).reason);
        expect(expectedError.originalError).toBe(error);
      });

      it("should throw generic IdentityproviderError on missing IdentityproviderErrorDto", async () => {
        ...
        expect(expectedError instanceof IdentityproviderError).toBeTruthy();
        expect(expectedError.message).toEqual(`Identityprovider-App responded with status ${error.response.status}. See 'originalError'-property for details.`);
        expect(expectedError.originalError).toBe(error);
      });
    });
    ...
    it("should throw generic IdentityproviderError on no response", async () => {
      ...
      expect(expectedError instanceof IdentityproviderError).toBeTruthy();
      expect(expectedError.message).toEqual(`Request to Identityprovider-App failed: ${error.message}. See 'originalError'-property for details.`);
      expect(expectedError.originalError).toBe(error);
    });
