...
import {LogOptions, ProviderFn, Severity} from "./types";
...
describe("DvelopLogger", () => {
  ...
  describe("severity function", () => {
    describe.each([
      ...
      test("should use logging provider", () => {return new Promise<void>(done => {
      ...
      test("should set severity", () => {return new Promise<void>(done => {
        const logger = new DvelopLogger({provider: [(_, logSeverity, __) => {
      ...
      test("should pass DvelopContext", () => {return new Promise<void>(done => {
        ...
        const logger = new DvelopLogger({provider: [(context, _, __) => {
      ...
      test("should set message in LogOptions", () => {return new Promise<void>(done => {
        const logger = new DvelopLogger({provider: [(_, __, options) => {
      ...
      test("should pass LogOptions as is", () => {return new Promise<void>(done => {
